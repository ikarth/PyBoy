...
from pyboy.plugins.game_wrapper_generic cimport GameWrapperGeneric
# imports end
...
cdef class PluginManager:
    ...
    cdef public GameWrapperGeneric game_wrapper_generic
    ...
    cdef bint game_wrapper_generic_enabled
    # plugin_cdef end
